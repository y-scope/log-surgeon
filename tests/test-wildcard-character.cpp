 ...
 */
TEST_CASE("normal_expression_character", "[WildcardCharacter]") {
 ...
 */
TEST_CASE("greedy_wildcard_expression_character", "[WildcardCharacter]") {
 ...
 */
TEST_CASE("non_greedy_wildcard_expression_character", "[WildcardCharacter]") {
 ...
 */
TEST_CASE("escape_expression_character", "[WildcardCharacter]") {
